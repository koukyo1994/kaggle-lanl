...
def main():
    ...
    train_aug = pd.read_csv(FEATURES_DIR / f'lanl-features-{slide_size}/train_aug_features_50000_0.5.csv')
    ...
    train_aug_denoised = pd.read_csv(FEATURES_DIR / f'lanl-features-{slide_size}/train_aug_features_denoised_50000_0.5.csv')
    ...
    # LB = 1.425
    # [951]     training's l1: 1.04323	valid_1's l1: 1.89176
    # [728]     training's l1: 1.20456	valid_1's l1: 1.95914
    # [772]     training's l1: 1.17107	valid_1's l1: 1.9457
    # [645]     training's l1: 1.27689	valid_1's l1: 1.92787
    # [1040]    training's l1: 0.981733	valid_1's l1: 1.95328
    # CV mean score: 1.9355, std: 0.0243.
    ...
    plot_result(result_dict_lgb_mini, y_aug)
    ...
    print(np.mean(np.abs(LB_1425["time_to_failure"].values - submission_mini["time_to_failure"].values)))
    print()
